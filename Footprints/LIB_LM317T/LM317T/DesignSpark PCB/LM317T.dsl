...
(library Library_1
	...
	(compDef "LM317T" (originalName "LM317T") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "ADJUST") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.st.com/web/en/resource/technical/document/datasheet/CD00000455.pdf")
		(attr "Height" "4.6 mm")
	)
